...
public interface IUserDeviceRepository
{
    ...
    Task<IEnumerable<UserDeviceEntity>>  RetrieveAllByIdAsync(Guid userId, CancellationToken cancellationToken);
    Task<List<UserDeviceEntity>> RetrieveAllTrainingTodayAsync(byte todayMask, CancellationToken cancellationToken);
